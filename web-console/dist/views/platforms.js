...
function capabilityRow(platform) {
    const row = document.createElement("tr");
    row.append(cell(platform.label), capabilityCell(platform.capabilities.text), capabilityCell(platform.capabilities.markdown), capabilityCell(platform.capabilities.image), capabilityCell(platform.capabilities.file), capabilityCell(platform.capabilities.mixedMessage), capabilityCell(platform.capabilities.streaming));
    return row;
}
