...
export function renderDashboard(status) {
    ...
    healthValue.className = `console-status overview-health-value ${status.runtime.state === "setup_required" ? "console-status--warn" : status.runtime.ok ? "console-status--good" : "console-status--error"}`;
