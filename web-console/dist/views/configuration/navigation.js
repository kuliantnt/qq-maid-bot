...
export function renderConfigurationNavigation() {
    ...
    if (!availableIds.has(selectedBusinessGroup))
        setSelectedBusinessGroup(available[0]?.id ?? "system-security");
...
export function isBusinessGroup(value) {
...
export function configurationTab(id, label, description) {
...
export function bindTabKeyboard(tab, tablist, index, count, activate) {
