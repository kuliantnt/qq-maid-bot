...
import { appendGroupedFields, button, configInput, element, fieldInput, inputId, inputValue, isEmptyInputValue, meta } from "./fields.js";
...
export function renderPublicFields(snapshot) {
...
export async function savePublicFields() {
    if (!current)
        return;
...
export async function removePublicField(key) {
    if (!current)
        return;
