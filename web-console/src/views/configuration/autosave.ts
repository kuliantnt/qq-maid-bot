...
export function shouldDeferAutosaveToButton(
...
export function agentSceneChanged(sceneName: string): boolean {
...
export function agentFieldChanged(id: string): boolean {
  if (!current?.agent) return false;
