export const CONSOLE_PAGE_IDS = ["overview", "platforms", "configuration", "storage", "tools"] as const;
export type ConsolePageId = (typeof CONSOLE_PAGE_IDS)[number];
export type ConsoleIconName = "overview" | "platforms" | "configuration" | "storage" | "tools";
