...
pub const DEFAULT_MAX_CONCURRENT_RESPONSES: u64 = 4; // 全局 LLM / Web Search 最大并发
...
mod tests {
    ...
    fn max_concurrent_responses_allows_zero_and_rejects_large_values() {
        ...
        let err = env_u64_bounded_zero_allowed("QQ_MAID_TEST_MAX_CONCURRENT_RESPONSES", 4, 256)
            .unwrap_err();
        assert_eq!(err.code, "config");
